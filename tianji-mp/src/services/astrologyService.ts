import type { UserProfile, BaziChart, PillarData, DaYunData, LiuNianData } from '@/models';
        ...
        for (let i = 0; i < loopLimit; i++) {
            ...
            for (let j = 0; j < liuNianArr.length; j++) {
                ...
                liuNianList.push({
                    ...
                    gan: lnGan,
                    zhi: lnZhi,
                    ganGod: getGod(dayGanName, lnGan),
                    zhiGod: getGod(dayGanName, ZHI_HIDDEN[lnZhi]?.[0] || ''),
                });
            }
            ...
            daYunList.push({
                ...
                gan: dyGan,
                zhi: dyZhi,
                ganGod: getGod(dayGanName, dyGan),
                zhiGod: getGod(dayGanName, ZHI_HIDDEN[dyZhi]?.[0] || ''),
                naYin: '',
                liuNian: liuNianList
            });
        }
